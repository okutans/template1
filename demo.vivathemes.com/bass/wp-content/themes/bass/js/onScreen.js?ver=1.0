...
jQuery(function(){
  jQuery('#searchresult, #content, #contentfull').onScreen({toggleClass: 'animated fadeIn go'});
  jQuery('#topwidget').onScreen({toggleClass: 'animated fadeIn delay-750 go'});
  jQuery('.headerimage').onScreen({toggleClass: 'animated fadeIn delay-250 go'});
  jQuery('.aboutus figure').onScreen({toggleClass: 'animated fadeInRightShort delay-250 go'});
  jQuery('.aboutus .wp-block-media-text__content').onScreen({toggleClass: 'animated fadeIn delay-500 go'});
  jQuery('.playlist .wp-block-column:not(:first-child)').onScreen({toggleClass: 'animated fadeInRightShort delay-250 go'});
  jQuery('.wp-block-post-template li, ul.products li').onScreen({toggleClass: 'animated fadeInUpShort delay-250 go'});
});
